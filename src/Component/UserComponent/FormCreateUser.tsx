...
export const FormCreateUser: React.FC<FormCreateUserProps> = ({ addUser }) => {
  ...
  const handleClickToAddUser = (event: React.MouseEvent<HTMLButtonElement>) => {
    event.preventDefault();
    addUser({ name: name, phoneNumber: phoneNumber });
    resetForm();
  };
    ...
    <div className="flex-col w-full">
      <form className="w-full" action="#">
        ...
        <div className="p-[5px] flex justify-center items-center border border-black-800 font-bold">
          <div className="mr-auto">Cập nhật thông tin nhân viên</div>
          <button
          ...
          <div className="avatar-status flex-col justify-center items-center w-[300px] mt-[20px]">
            ...
            <div className="flex justify-center">
              ...
              <input
                ...
                value="block"
              />
              <label className="mr-[8px]" htmlFor="status">
                Khóa
              </label>
              <input
                className="mr-[3px]"
      ...
      <div className="p-[5px] flex justify-center items-center border border-black-800 font-bold">
        ...
        <button
          onClick={handleClickToAddUser}
          className="text-red-500 ml-10 bg-white border p-[10px] pt-[3px] pb-[3px]"
          type="button"
        >
          Lưu
        </button>
